...
{id:'entry_powerball',name:'엔트리파워볼',family:'ball',cycleSeconds:300,roundsPerDay:288,displayGroup:'more',renderer:'ball',active:true},
{id:'entry_powerladder',name:'엔트리파워사다리',family:'ladder',cycleSeconds:300,roundsPerDay:288,displayGroup:'more',renderer:'ladder',active:true},
{id:'entry_kenoladder',name:'엔트리키노사다리',family:'ladder',cycleSeconds:300,roundsPerDay:288,displayGroup:'more',renderer:'ladder',active:true},
{id:'entry_speedkeno',name:'엔트리스피드키노',family:'keno',cycleSeconds:300,roundsPerDay:288,displayGroup:'more',renderer:'keno',active:true},
{id:'named_powerball',name:'네임드파워볼',family:'ball',cycleSeconds:300,roundsPerDay:288,displayGroup:'more',renderer:'ball',active:true},
{id:'named_powerladder',name:'네임드파워사다리',family:'ladder',cycleSeconds:300,roundsPerDay:288,displayGroup:'more',renderer:'ladder',active:true}
]);
